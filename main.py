...
# def score():
def monster():
    global monster_life, monster_cd, monster_timer
    monster_life = random.randint(3, 5)
    monster_timer = monster_life
    print("vie : ", monster_timer)
    monster_cd = 0
...
while running:
    ...
    for hearts in range(monster_life):
        screen.blit(small_heart, (screen.get_width() // 1.19 - monster_timer * 15 + hearts * 25, 260))
